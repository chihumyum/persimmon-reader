  ...
  return (
    <LegalShell title="Support" subtitle="支持" lastUpdated="August 12, 2026">
      <section className="legal-document" lang="zh-Hans">
        <h2>中文</h2>
        <p>
          如果你在使用 Persimmon 时遇到问题，请发送邮件联系我们。我们会尽力帮助你解决
          EPUB 导入、阅读或 Google Drive 同步问题。
        </p>
        <p>
        ...
        <h3>支持的电子书</h3>
        <p>
          Persimmon 支持无 DRM、可重排的 EPUB 2/3 电子书。目前不支持 PDF、MOBI、DRM
          加密或固定版式 EPUB。
        </p>
        ...
        <h3>GitHub</h3>
        <p>
          你也可以在 <a href={githubUrl}>GitHub</a> 查看 Persimmon 项目并提交技术问题。
        </p>
      </section>
      ...
      <section className="legal-document" lang="en">
        <h2>English</h2>
        <p>
          If you run into a problem with Persimmon, email us for help with EPUB imports,
          reading, or Google Drive sync.
        </p>
        <p>
          <a className="support-contact-link" href={supportMailto}>
            Email support
        ...
        <p>
          Persimmon supports DRM-free, reflowable EPUB 2/3 books. PDF, MOBI, DRM-protected,
          and fixed-layout EPUB files are not currently supported.
        </p>
